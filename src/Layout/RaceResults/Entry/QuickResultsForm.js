...
import styles from './QuickResultsForm.module.css';

const QuickResultsForm = (props) => {
  ...
  ///////////////
  //Testing to see if old results populate
  ...
  useEffect(() => {
    //posting data
    const fetchData = async () => {
      const response = await fetch('/api/add_racer_time', {
        method: 'POST',
        body: JSON.stringify({
...
export default QuickResultsForm;
